...
/** Spanish Cordis UI messages, checked complete against the zh key set. */
export const es = {
  ...
  'status.idle': 'Listo',
  'status.awaitingApproval': 'Pendiente de aprobación',
  'status.failed': 'Ejecución fallida',
  'status.clientPending': 'Client listo para activarse',
  ...
  'panel.hint': 'Los controles de ejecución están en el panel de Cordis, encima de Configuración',
  'panel.plugins.aria': 'Plugins de Cordis',
  'panel.approvals.aria': 'Aprobaciones de Cordis',
  'panel.trigger': 'Cordis Plugin',
  'panel.runningCount': '{count} running',
  'panel.title': 'Plugins de Cordis',
  'panel.empty': 'Aún no hay ningún plugin definido',
  ...
  'panel.next': 'Pendiente: {packageId}',
