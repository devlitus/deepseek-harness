...
// Same shared string as PLAN_NEXT_ACTION_ZH/EN: claimed /plan hint and
// plan-mode textarea placeholder.
...
export const es = {
  ...
  'image.dropBlocked': 'No se pueden añadir imágenes ahora',
  ...
  'image.totalTooLarge': 'Las imágenes superan {size} en total; elimina algunas e inténtalo de nuevo',
  'image.tooManyPixels': 'La resolución de la imagen es demasiado alta; comprímela e inténtalo de nuevo',
  'image.dimensionTooLarge': 'Los lados de la imagen deben ser de {size}px como máximo; redúcela e inténtalo de nuevo',
  'image.modelUnsupported': 'El modelo actual no admite imágenes; cambia a un modelo que las admita',
  ...
  'command.imagesUnsupported': '/{command} no acepta archivos adjuntos de imagen; elimínalos primero',
  ...
  'queue.edit.unsupported': 'Contiene contenido que no es texto; la edición aún no está disponible',
