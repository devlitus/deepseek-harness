 ...
 * unresolved; the residual case points at English rather than zh because a
 * browser naming no shipped language is the reader least likely to read
 * Chinese.
 */
...
export class LocaleRuntime {
   ...
   * compile error), and every shipped locale is required (all-locale balance
